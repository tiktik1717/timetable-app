...
export default function ConstraintGroupsPanel({
    ...
    return (
        <div className="constraint-panel">
            ...
            <div className="constraint-item readonly-constraint">
                <span
                    className="constraint-color"
                    style={{ backgroundColor: homeroomTeacherColor }}
                />
                <span className="constraint-name">מחנך/ת כיתה</span>
                <span className="constraint-type"></span>
            </div>
